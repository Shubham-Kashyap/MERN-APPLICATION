                ...
                <div className="register register-with-news-feed">
                    ...
                    <div className="news-feed">
                        ...
                        <div className="news-caption">
                            ...
                            <p>
                                As a React application user, you use the dashboard console to manage your account, such as add new users to your chats , create groups, manage security settings.
                            </p>
                        </div>
                    </div>
                    {/* <!--  end news-feed --> */}
                    ...
                    <div className="right-content">
                        ...
                        <h1 className="register-header">
                            Sign Up
                            <small>Sign up with the react application. It’s free and always will be.</small>
                        </h1>
                        {/* <!--  end register-header --> */}
                        ...
                        <div className="register-content">
                            <form action="index.html" method="GET" className="margin-bottom-0" onSubmit={register}>
                                ...
                                <p className="text-center mb-0">
                                    &copy; React application All Right Reserved {new Date().getFullYear()}
                                </p>
                            </form>
                        </div>
